...
const FAQ = [
  ...
  },
  {
    ...
    a: "TuChat tiene más de 260 salas: por países (España, México, Argentina y más de 25 países), por ciudades (Madrid, Barcelona, Buenos Aires, Ciudad de México y más de 170 ciudades), y por temáticas (amor, amistad, ligar, deportes, música, anime y más).",
  },
  {
