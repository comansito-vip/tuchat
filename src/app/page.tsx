...
const FAQ = [
  ...
  },
  {
    ...
    a: "TuChat tiene más de 890 salas: por países (España, México, Argentina y 29 países en total), por ciudades (Madrid, Barcelona, Buenos Aires, Ciudad de México y más de 470 ciudades), y por temáticas (amor, amistad, ligar, deportes, música, anime y más).",
  },
  {
