...
const FAQ = [
  ...
  },
  {
    ...
    a: "TuChat tiene más de 1.200 salas: por países (España, México, Argentina y 30 países en total), por ciudades (Madrid, Barcelona, Buenos Aires, Ciudad de México y más de 800 ciudades), y por temáticas (amor, amistad, ligar, deportes, música, anime y más).",
  },
  {
