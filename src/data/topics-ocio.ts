...
export const TOPICS_OCIO: Place[] = [
  {
    ...
    related: ["humor", "memes", "chistes", "cafe", "mama-luna", "encuestas", "adivinanzas"],
  ...
  },
  {
    ...
    channels: ["ocio", "amistad"],
    related: ["ocio", "memes", "chistes", "messenger", "laguna2000", "amistad", "juegos"],
  ...
  },
  {
    ...
    parentSlug: "ocio", parentName: "Ocio",
    channels: ["ocio", "amistad"],
    related: ["ocio", "humor", "chistes", "canalchat", "tecnologia", "juegos"],
