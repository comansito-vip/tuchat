...
export const TOPICS_REGIONES_AM: Place[] = [
  ...
  },
  {
    ...
    about:
      "Culiacán y Mazatlán son dos maneras distintas de ser sinaloense y en esta sala coinciden: la capital trabaja y el puerto presume de playa. El carnaval de Mazatlán aparece cada febrero y se defiende como uno de los más antiguos y multitudinarios de México, con la seguridad de quien no piensa entrar a discutirlo. La banda suena acá de otra manera, porque la tambora no se pide, se impone, y hay quien la defiende contra el mundo entero. El aguachile se come picoso y a quien lo pida suave le caen burlas amables. Se habla más de béisbol que de fútbol: Tomateros y Venados parten la sala en temporada. El estado le da de comer a medio país con su tomate y su maíz, y eso se dice con orgullo en cuanto alguien reduce Sinaloa a lo de siempre.",
  },
  {
    slug: "zulia",
    name: "Zulia",
