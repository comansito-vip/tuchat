...
export const CITIES_GENERADAS: Place[] = [
  ...
  },
  {
    ...
    "intro": "Palermo, en el noroccidente del Huila, cuenta con 34.987 habitantes (proyección DANE 2019) y se destaca como el «Municipio Marmolero del Huila».",
    "aboutTitle": "Palermo, el Municipio Marmolero del Huila",
    "about": "Palermo es un municipio colombiano situado en el noroccidente del departamento del Huila, dentro de la región andina y de la zona SubNorte. Se extiende sobre 917 km² en el alto del valle del Magdalena, a orillas de la quebrada Nilo, y se ubica a 690 metros sobre el nivel del mar con una temperatura promedio de 27 °C. Según la proyección del DANE para 2019, la población alcanza los 34.987 habitantes. La fundación oficial data de 1690 bajo el nombre de Guagua, obtuvo la categoría de municipio en 1782 y adoptó el nombre de Palermo en 1906 por razones religiosas.\n\nLa economía de Palermo se sustenta principalmente en la agricultura y el comercio; el café y el arroz son los cultivos más destacados. Además, el territorio alberga extracción de hidrocarburos, mármol, calizas y dolomitas, materias primas empleadas en la agricultura y la industria. Cerca de la capital Neiva se encuentra la zona industrial de Amborco, una de las áreas en desarrollo del departamento. Por esta actividad minera, el municipio es conocido como el «Municipio Marmolero del Huila». Dentro de su jurisdicción están los centros poblados de Amborco, Betania, El Juncal, Ospina Pérez y San Juan, y su relieve incluye una zona montañosa occidental, un valle pintoresco donde está la cabecera, un cordón de cerros graníticos y una planicie oriental del Valle del Magdalena."
  },
  {
    "slug": "abasto",
    "name": "Abasto",
  ...
  },
  {
    ...
    "intro": "Simón Bolívar, nacido el 24 de julio de 1783 en Caracas, lideró la Campaña Admirable y obtuvo el título de Libertador de Venezuela.",
    "aboutTitle": "Campaña Admirable y el título de Libertador de Venezuela",
    "about": "Simón José Antonio de la Santísima Trinidad Bolívar Ponte y Palacios Blanco nació en Caracas el 24 de julio de 1783 y falleció en Santa Marta el 17 de diciembre de 1830. Fue militar, estratega y político venezolano, reconocido como el Libertador por su papel decisivo en la independencia de Venezuela, Colombia, Ecuador y Panamá, y por su participación en la emancipación de Perú. Durante la Campaña Admirable recibió el título de Libertador de Venezuela y fundó la Gran Colombia, un proyecto de unión que buscaba consolidar los nuevos estados sudamericanos. Además, aprobó el reconocimiento de Bolivia como república y estuvo involucrado en la creación de la República Bolívar, que luego pasó a llamarse República de Bolivia. En sus últimos años se desilusionó con los resultados de las repúblicas surgidas, renunció a la presidencia de Colombia y murió de tuberculosis. Su legado ha generado tanto admiración como controversia, señalándosele autoritarismo y el Decreto de Guerra a Muerte, pero también se le recuerda como figura central de la emancipación hispanoamericana.\n\nSu nombre ha quedado asociado a numerosos topónimos, instituciones y celebraciones en toda América Latina, reflejando la influencia duradera de su liderazgo y visión de una América unida."
  },
  {
    "slug": "la-florida",
    "name": "La Florida",
  ...
  },
  {
    ...
    "intro": "Santa Catarina, a 9 km west suburb of Monterrey, cuenta con 304.052 habitantes según el censo 2020 y fue declarada ciudad el 20 de noviembre de 1977.",
    "aboutTitle": "Santa Catarina: origen histórico y datos demográficos",
    "about": "Santa Catarina, también conocida como Ciudad Santa Catarina, es una ciudad mexicana ubicada en el estado de Nuevo León, cabecera del municipio homónimo y parte de la zona metropolitana de Monterrey. Se sitúa a 9 km al poniente de Monterrey, dentro de las coordenadas norte 25º45', sur 25° 25' latitud norte; 100° 43' al oeste y al este 100º 14' longitud oeste, a una altitud de 680 metros sobre el nivel del mar. El nombre rinde honor a la santa católica Catalina de Alejandría, patrona de filósofos, estudiantes, maestros y predicadores. Su origen se remonta a 1577, cuando Alberto del Canto dejó una estancia destinada a servir como descanso entre los viajes de Monterrey a Saltillo. Amparado en las Cortes de Cádiz, en 1820 se constituyó su primer cabildo bajo Joaquín García, llamándose Valle de Santa Catarina, y desde 1861 se le denominó villa. El 20 de noviembre de 1977 fue elevada a la categoría de ciudad. De acuerdo con el censo de población del año 2020 del INEGI, Santa Catarina cuenta con 304.052 habitantes (151.417 hombres y 152.635 mujeres). En ese mismo censo se registran 89.573 viviendas particulares, de las cuales 82.189 están habitadas; 81.375 disponen de energía eléctrica, 81.265 de baño y 81.223 de drenaje."
  },
  {
  ...
  },
  {
    ...
    "intro": "Escobar, en la provincia de Buenos Aires, está en el centro del partido, a 50 km de la capital y en la intersección de la ruta 25 y la Panamericana.",
    "aboutTitle": "Escobar: cruce de rutas y legado guaraní",
    "about": "Belén de Escobar es una ciudad del nordeste de la provincia de Buenos Aires, capital del partido homónimo. Está situada en el centro del partido, en la intersección de la ruta provincial 25 y la ruta Panamericana, a unos 50 km de la Ciudad Autónoma de Buenos Aires. El crecimiento del Gran Buenos Aires durante las últimas décadas del siglo XX incorporó a Escobar a un continuo edilicio, convirtiéndola en una de las zonas residenciales de mayor expansión del conurbano.\n\nEl relieve es de llanura con discretas lomadas, guadales y albardones, típico del delta del Paraná. Antes de la llegada de los españoles, la zona estaba habitada por guaraníes que aprovechaban la cercanía de los ríos Paraná de las Palmas y Luján. Las primeras tierras fueron repartidas por Juan de Garay y, en 1582, entregadas a Alonso de Escobar, de quien proviene el nombre del lugar. Actualmente, el intendente es Ariel Sujarchuk."
  },
  {
    "slug": "turmero",
    "name": "Turmero",
  ...
  },
  {
    ...
    "intro": "Gregorio de Laferrere, localidad del Gran Buenos Aires con 253.993 habitantes (Censo 2022), se ubica a 13 km del acceso más cercano a la Ciudad Autónoma.",
    "aboutTitle": "Fundación y datos clave de Gregorio de Laferrere",
    "about": "Gregorio de Laferrere es una localidad del partido de La Matanza, en la provincia de Buenos Aires, Argentina. Forma parte del aglomerado urbano del Gran Buenos Aires (AMBA) y está situada a 13 km del acceso más cercano a la Ciudad Autónoma de Buenos Aires, por la Autopista Teniente General Pablo Ricchieri, y a 24 km del centro de la capital. Con 253.993 habitantes según el Censo 2022, es la segunda localidad más poblada del partido, después de González Catan, y una de las más pobladas del conurbano bonaerense. La ciudad ocupa 23,7 km² y su trazado urbano sigue un patrón de damero interrumpido solo por dos avenidas diagonales.\n\nEl epicentro se localiza al norte de la estación del ferrocarril y concentra la delegación municipal, dos comisarías y la ex sede del Aeroclub Argentino, que fue pionero en la aviación nacional antes de ceder su predio para el Hospital SAMIC. Fue fundada el 4 de mayo de 1911, tras la solicitud de Pedro Luro, Honorio Luque y el propio Gregorio de Laferrere, quien dio nombre al pueblo en honor al escritor y político que propuso su creación. El objetivo original era un pueblo de fin de semana con chalets; Laferrere falleció dos años después de la fundación."
  },
  {
    "slug": "monclova",
    "name": "Monclova",
  ...
  },
  {
    ...
    "intro": "Guacara, capital del municipio homónimo en Carabobo, cuenta con 220 212 habitantes (2023) y se sitúa a 438 m sobre el nivel del mar, a 10 km de Valencia.",
    "aboutTitle": "Guacara: ciudad industrial cerca del lago de Valencia",
    "about": "Guacara, oficialmente San Agustín de Guacara, es una ciudad venezolana y capital del Municipio Guacara, en el Estado Carabobo, Región Central. Fue fundada como pueblo indígena en 1624 con el nombre de San Agustín de Guacara. Está ubicada a 438 m s. n. m., al noreste del lago de Valencia, y se encuentra en el paso de la Autopista Regional del Centro, la principal y más transitada autopista del país, que comunica a Caracas, Maracay y Valencia, a tan solo 10 km de esta última. Forma parte de una conurbación que alberga algunas de las zonas industriales más importantes de Venezuela.\n\nEl primer poblamiento localizado en el morro de Guacara data de 4 500 años, aunque el ascenso de las aguas obligó al abandono posterior. La toponimia proviene del indio principal Gaicaro y, según algunas interpretaciones, la palabra guacara podría significar \"garza blanca\" o \"tesoro escondido\". En 2023 la población se estimó en 220 212 habitantes, lo que refleja su crecimiento impulsado por la ubicación estratégica y el tránsito comercial de la Región Central."
  },
  {
    "slug": "tocuyito",
    "name": "Tocuyito",
  ...
  },
  {
    ...
    "intro": "Cuautla de Morelos, conocida como la Heroica e Histórica Ciudad, cuenta con más de 157 000 habitantes y destaca por su legado histórico y cultural.",
    "aboutTitle": "Cuautla de Morelos: Heroica Ciudad y zona de monumentos históricos",
    "about": "Cuautla, cuyo nombre proviene del náhuatl Cuāuhtlan o Kwāwtlan ‘Lugar de las águilas’, es la Heroica e Histórica Ciudad de Cuautla de Morelos, capital del municipio homónimo y ciudad central que constituye el núcleo de la zona metropolitana. Con una población de 157 336 habitantes, es la segunda ciudad más importante del estado, solo superada por la zona metropolitana de Cuernavaca. Según el censo de 2020, la zona metropolitana supera los 483 455 habitantes. En 2012 el congreso local aprobó el título de Heroica Ciudad de Cuautla, Capital Histórica de Morelos, y el 28 de noviembre de ese año el presidente Felipe Calderón firmó en la Antigua estación del Ferrocarril el decreto que la declaró Zona de Monumentos Históricos. La ciudad conserva huellas de culturas prehispánicas, como la presencia olmeca en Chalcatzingo y la fundación de varios pueblos del Plan de Amilpas durante la época de Moctezuma Ilhuicamina y su legado sigue presente."
  },
  {
    "slug": "la-pintana",
    "name": "La Pintana",
  ...
  },
  {
    ...
    "intro": "Acuña, ciudad coahuilense a 280 m sobre el nivel del mar, se asienta donde el arroyo Las Vacas se une al río Bravo, a 517 km de Saltillo.",
    "aboutTitle": "Confluencia del arroyo Las Vacas y el río Bravo en Acuña",
    "about": "Ciudad Acuña es la cabecera del municipio homónimo, situada en el estado de Coahuila a una altitud de 280 m s. n. m. Fue nombrada en honor al escritor Manuel Acuña. La urbe se fundó en el punto donde el arroyo de Las Vacas desemboca en el río Bravo, que marca la frontera con Estados Unidos y permite el cruce mediante un puente hacia Del Río, Texas, siendo una de las dos ciudades fronterizas del estado. \n\nInicialmente llamada Garza Galán en 1880, pasó a Congregación Las Vacas en 1884 y en 1912 adoptó el nombre de Villa Acuña. Destacan episodios como la llegada de los primeros colonos el 12 de diciembre de 1850, la formación de la colonia militar Manuel Leal en junio de 1860 con 60 soldados, y el movimiento armado del 26 de junio de 1908, precursor de la Revolución mexicana, entre rebeldes del PLM y tropas federales."
  },
  {
    "slug": "ezeiza",
    "name": "Ezeiza",
  ...
  },
  {
    ...
    "intro": "Nacajuca, cabecera municipal de Tabasco, está a 24 km al noroeste de Villahermosa y destaca por su alta concentración de hablantes de maya‑chontal.",
    "aboutTitle": "Nacajuca: comercio, agricultura y herencia maya‑chontal",
    "about": "Nacajuca es una localidad mexicana, cabecera del municipio homónimo en Tabasco, una de las cabeceras municipales con menor población del estado. Se sitúa a 24 km al noroeste de Villahermosa y a 5 km al sur de Jalpa de Méndez. La zona concentra una de las mayores poblaciones indígenas que habla maya‑chontal en todo Tabasco. Las actividades económicas principales son el comercio y la agricultura.\n\nEl nombre proviene del náhuatl Naca‑shushu‑can, que significa “lugar de las caras pálidas o descoloridas”. Los asentamientos humanos se remontan a la época en que grandes urbes mayas como Palenque, Tikal o Bonampá fueron abandonadas, y la población indígena, llamada Nacaxuxuca, se fundó el 13 de junio de 1325. En la llegada de los españoles en 1518, los maya chontales ocupaban el delta de los ríos Mezcalapa, Grijalva y Usumacinta; Hernán Cortés pasó por la zona en 1524‑1525 y la describió como Anaxuxuca, aludiendo a la presencia de mosquitos y al paludismo."
  },
  {
  ...
  },
  {
    ...
    "intro": "Naguanagua, capital del municipio homónimo en Carabobo, Venezuela, alberga la Universidad de Carabobo y, en 2016, tenía 185.713 habitantes.",
    "aboutTitle": "Abundancia de aguas y economía de Naguanagua",
    "about": "Naguanagua es una localidad venezolana, capital del Municipio Naguanagua, Estado Carabobo, situada en la Región Central del país. Según datos de 2016, la población alcanzó los 185.713 habitantes. La ciudad destaca por su amplia zona económica y comercial y por albergar instituciones como la Universidad de Carabobo, el primer complejo de edificios del World Trade Center Valencia en Venezuela y el segundo Centro Comercial Sambil del país.\n\nEl origen del nombre es incierto; algunos autores lo relacionan con el cacique Inagoanagoa, mientras que otros lo interpretan como “abundancia de aguas” o lo asocian a los ríos que confluyen cerca del asentamiento, como el Retobo y el Cabriales. En la época colonial la zona estaba habitada por pueblos indígenas Caribe y Arawak, cuya subsistencia se basaba en la agricultura, la caza y la pesca. En el siglo XVI los españoles descubrieron el cercano Lago de Valencia en 1547 y, a finales del siglo XVII, un grupo de vecinos empezó a poblar el valle."
  },
  {
    "slug": "villa-alemana",
    "name": "Villa Alemana",
  ...
  },
  {
    ...
    "intro": "Colina, capital de la provincia de Chacabuco en la Región Metropolitana de Santiago, lleva el nombre mapuche que significa 'perdiz'.",
    "aboutTitle": "Colina: capital de Chacabuco y legado del Camino del Inca",
    "about": "Colina es una comuna y ciudad chilena situada al norte de la Región Metropolitana de Santiago, y constituye la capital de la provincia de Chacabuco. Dentro de su territorio se encuentran localidades como Chicureo, Chamisero, Peldehue, Las Canteras, Casas de Chacabuco y Esmeralda, que forman parte del entramado urbano y rural de la zona.\n\nEl origen del nombre proviene de la lengua mapuche y significa “perdiz”, aunque también se menciona la posible derivación del cacique “Colinura”, cuyo término quechua traduciría ‘Jefe de Bríos’. La presencia humana data del Holoceno, con rastros de culturas Bato, Llolleo, Aconcagua y Diaguita, y posteriormente de los picunches. En 1426 el Imperio Inca invadió el territorio, estableciendo un centro administrativo y un Templo al Sol que nunca se ha hallado; el Camino del Inca cruzaba la zona en su ruta hacia el Gran Tambo de Mapocho. Las chacras locales fueron regadas históricamente por el estero Colina, y la interacción inca‑picunches dejó huellas en la alfarería y la agricultura."
  },
  {
    "slug": "boca-chica",
    "name": "Boca Chica",
  ...
  },
  {
    ...
    "intro": "La Lisa, municipio de la provincia de La Habana, cuenta con 130.969 habitantes y una superficie de 37,5 km² en la periferia oeste de la capital.",
    "aboutTitle": "La Lisa: zona urbana del Quibú y sus barrios tradicionales",
    "about": "La Lisa es un municipio de la provincia de La Habana que surgió tras la división político‑administrativa de 1976. Se sitúa en la periferia oeste de la capital cubana y limita al norte con el municipio Playa, al este con Marianao, al sur‑sureste con Boyeros y al oeste con el municipio Bauta, de la provincia vecina de Artemisa. El municipio agrupa a los repartos y barrios de El Cano, Guatao, Arroyo Arenas, La Lisa, Punta Brava, entre otros, y se divide en dos áreas bien diferenciadas: al noreste, desde el Quibú hasta Arroyo Arenas y desde la Autopista Nacional a la calle 25, predomina la urbanización continua; al suroeste predomina un carácter suburbano o semirrural, con zonas como Cano‑Valle Grande, La Concepción y parte de Guatao.\n\nCon una extensión territorial de 37,5 km², La Lisa alberga a 130.969 habitantes, lo que supone una densidad de 3.492,5 habitantes por km². El crecimiento anual de la población se sitúa en torno al 1,05 %, cifra que refleja su carácter periférico y la dispersión de los asentamientos originales. Estas condiciones hacen de La Lisa uno de los municipios menos densamente poblados de la capital, combinando zonas urbanas consolidadas con áreas de carácter más rural."
  },
  {
    "slug": "yaritagua",
    "name": "Yaritagua",
    ...
    "intro": "Yaritagua, capital del Municipio Peña en Yaracuy, cuenta con 136 081 habitantes (censo 2015) y se extiende sobre 510 km² a 328 km de Caracas.",
    "aboutTitle": "Yaritagua: ciudad de la caña y la quebrada Santa Lucía",
    "about": "Yaritagua es una ciudad venezolana capital del Municipio Peña en el Estado Yaracuy. Está ubicada en la Región Centroccidental de Venezuela y forma parte de la zona metropolitana de Barquisimeto, junto al Municipio Iribarren y Municipio Palavecino y Quíbor, Duaca, Sanare y Sarare del Estado Lara. Se encuentra a 328 km de Caracas y a orillas de la quebrada Santa Lucía, afluente del Río Turbio. Tiene una superficie de 510 km² y una población de 136 081 habitantes según el censo de 2015. Es la segunda área más poblada de Yaracuy después de San Felipe y se considera un suburbio de Barquisimeto.\n\nEn el siglo XX el cultivo tecnificado de caña de azúcar impulsó la instalación de centrales azucareros, convirtiendo a Yaritagua en una referencia de esa industria. A finales del siglo XX y principios del XXI la actividad azucarera declinó, agravada por la hiperinflación y la escasez de la década del 2010, lo que provocó éxodo de habitantes. Dentro del municipio se reconocen comunidades como Agua Negra, Albarical, Arenales, Cambural, Camino Nuevo, Cañaveral, Cujisal, Don Nicola, El Carmelero, El Jardín, El Jobito, El Li."
  },
  {
  ...
  },
  {
    ...
    "intro": "Almoloya de Juárez, Estado de México, lleva un nombre náhuatl que significa 'lugar donde mana la fuente de agua' y celebra su fiesta patronal el 19 de marzo.",
    "aboutTitle": "El Ojo de Agua y la fiesta de San José en Almoloya de Juárez",
    "about": "Almoloya de Juárez es una población mexicana situada en el Estado de México y forma parte de la zona metropolitana de Toluca, siendo la cabecera del municipio homónimo. El escudo municipal muestra la silueta de Benito Juárez y cinco corrientes de agua que remiten al origen náhuatl de su nombre, mientras que el Santuario de San Pedro del Ojo de Agua destaca por su estilo barroco y por el manantial conocido como “Ojo de Agua”, fuente que da nombre al lugar. \n\nLa historia local registra que el primer encomendero fue Juan de Sámano, quien en 1537 obtuvo la encomienda. La fertilidad del territorio propició el desarrollo de haciendas como La Gavia, Las Llaves, San Miguel y La Galera. La parroquia de San José de Almoloya se erigió en 1568 bajo la administración del clero secular, y la documentación municipal inicia en 1591. Entre sus festividades destacan el Corpus Christi, la celebración de la Virgen del Carmen con procesión al santuario de Toluca, y el 19 de marzo la fiesta en honor al santo patrono San José."
  },
  {
    "slug": "machiques",
    "name": "Machiques",
  ...
  },
  {
    ...
    "intro": "Porlamar, capital del municipio Mariño en Nueva Esparta, está en la bahía de Guaraguao frente al Caribe y es el centro económico de la Isla de Margarita.",
    "aboutTitle": "Puerto de Guaraguao y la fundación de Porlamar (1536)",
    "about": "Porlamar es la capital del municipio Mariño, en el estado Nueva Esparta, y constituye el principal centro urbano y económico de la Isla de Margarita. Se sitúa en la costa sureste de la isla, frente al mar Caribe, dentro de la bahía de Guaraguao. Aproximadamente a diez kilómetros de La Asunción, la ciudad funciona como núcleo principal de actividades económicas y de servicios en la región insular. Los habitantes son conocidos como porlamarenses.\n\nLa fundación oficial tuvo lugar el 26 de marzo de 1536, cuando el fraile Francisco de Villacorta estableció la nueva villa y erigió la iglesia bajo la advocación de Nuestra Señora de La Asunción. Antes de adoptar el nombre actual, la localidad fue conocida como San Pedro Mártir, Villa del Espíritu Santo, Pueblo de La Mar y, a mediados del siglo XIX, tomó el nombre de Porlamar. En 1526 la gobernadora Isabel Manrique envió a sus tenientes Pedro de Villárdiga y Pedro Alegría para construir un fuerte en la bahía de Guaraguao, llamado San Pedro Mártir. El asentamiento sufrió ataques de piratas, como el francés Jacques de Sores en 1555 y el tirano Lope de Aguirre en 1561, lo que obligó a su mudanza al valle de Santa Lucía alrededor de 1567. Posteriormente, el gobernador Miguel Maza de Lizana declaró en 1580 que en el Pueblo de la Mar se concentraba la mayor cantidad de indígenas y ordenó la creación de un pueblo de indios allí."
  },
  {
  ...
  },
  {
    ...
    "intro": "Tinaquillo, ciudad de Cojedes a 420 m de altitud, cuenta con 124.919 habitantes (2021) y se fundó el 25 de abril de 1760.",
    "aboutTitle": "Tinaquillo y su zona industrial textil a orillas del río Tamanaco",
    "about": "Tinaquillo es una ciudad del estado Cojedes, en Venezuela, capital del Municipio Tinaquillo. Se localiza en una altiplanicie a las orillas del río Tamanaco, a 420 metros sobre el nivel del mar, y está conectada por la troncal 005 que la une con Valencia y Tinaco. La fecha de fundación se toma como el 25 de abril de 1760, cuando recibió el llamado a \"Recogimiento a Pueblo\" bajo el nombre de Nuestra Señora del Socorro de Tinaquillo. Según el censo de 2021, la población asciende a 124.919 habitantes.\n\nEl paso de la autopista Troncal 005 y la cercanía a Valencia impulsaron un rápido crecimiento residencial e industrial. En la zona se concentran industrias textiles, el conglomerado industrial de CorpoIndustria, una zona industrial municipal y actividades agrícolas, comerciales, bancarias, turísticas y mineras. El nombre proviene del río Tinaquillo, diminutivo de Tinaco; \"tinaco\" sería una palabra indígena arawaca que designa un gran recipiente, y el radical \"tuna\" significa río o agua en la lengua caribe. Cerca se encuentra el río Tinapui y la Aguadita, donde brotan aguas termales con fuerte olor sulfuroso."
  },
  {
    "slug": "huaral",
    "name": "Huaral",
    ...
    "intro": "Huaral, capital de su provincia en Lima, está a 80 km al norte de la capital peruana y destaca como la \"Capital de la agricultura\" del país.",
    "aboutTitle": "Río Chancay y la Capital de la Agricultura en Huaral",
    "about": "Huaral es una ciudad peruana que funciona como capital del distrito y de la provincia homónimos, situada en el departamento de Lima. A 188 m sobre el nivel del mar, se ubica en la zona baja de la cuenca del río Chancay, a 80 km al norte de la ciudad de Lima y a 11 km al noreste del puerto de Chancay y del océano Pacífico. Con una población de 79 455 habitantes en 2017, la ciudad se ha ganado el sobrenombre de \"Capital de la agricultura\" y también de \"Despensa de Lima\" por la abundante producción de los valles circundantes.\n\nLa fundación de Huaral se remonta al 21 de marzo de 1551, bajo una orden real del virrey Antonio de Mendoza y Pacheco, bajo la advocación de San Juan Bautista, sustituyendo a la población prehispánica llamada Guaral Viejo. El nombre proviene del cacique Martín Guaral Paico, según el historiador Jesús Elías Ipince. Entre sus platos típicos destaca el Chancho al Palo, y la ciudad conserva la tradición de varios ayllus como Guaril, Huando o Jecuán."
  },
  {
    "slug": "moran",
    "name": "Morán",
    ...
    "intro": "Morán, municipio del sur de Lara, cuenta con 167.876 habitantes según el censo 2017 y una superficie de 2.231 km².",
    "aboutTitle": "Agricultura y café en el municipio Morán (Lara)",
    "about": "Morán es un municipio ubicado al sur del estado Lara, Venezuela. Limita al norte con el municipio Torres, al sur con el estado Portuguesa, al este con los municipios Andrés Eloy Blanco y Jiménez, y al oeste con el estado Trujillo. Su capital es la ciudad El Tocuyo. El municipio se divide en ocho parroquias: Anzoátegui, Bolívar, Santa Cruz de Guárico, Hilario Luna y Luna, Humocaro Bajo, Humocaro Alto, La Candelaria y Morán.\n\nLa economía de Morán se basa principalmente en la agricultura. En las zonas montañosas predomina la producción de café, mientras que en el valle se cultivan caña de azúcar y hortalizas, lo que configura un paisaje agrícola diverso y esencial para la región. El relieve combina zonas montañosas con extensos valles fértiles, permitiendo la coexistencia de cultivos de altura y de bajo valle. Esta diversidad agrícola ha convertido a Morán en un proveedor importante de café y caña para el mercado regional. Según el censo de 2017, el municipio cuenta con 167.876 habitantes y una superficie de 2.231 km². Los habitantes se distribuyen entre las ocho parroquias, manteniendo tradiciones agrícolas transmitidas de generación en generación."
  },
  {
    "slug": "catacamas",
    "name": "Catacamas",
    ...
    "intro": "Catacamas, municipio del departamento de Olancho en Honduras, se ubica en el Valle del Guayape a 450 m s.n.m. y cubre 7.173,89 km² de territorio.",
    "aboutTitle": "Montaña Piedra Blanca y el Valle del Guayape en Catacamas",
    "about": "Catacamas es un municipio del departamento de Olancho, en la República de Honduras. Se sitúa en el Valle del Guayape, a 450 metros sobre el nivel del mar, y ocupa una superficie de 7.173,89 km², lo que lo convierte en el municipio más extenso del país. Sus coordenadas son 14°54′04″ N y 85°55′31″ W, y se encuentra a 210 km de la capital, Tegucigalpa. El origen del nombre tiene varias versiones: según la tradición antropológica proviene de Atlakamani, diosa azteca del agua; etimológicamente se desglosa en “Catac” (andar) y “Camas” (dormir); y en relatos populares se asocia al sonido del maíz golpeando la cama de cuero o al cacique copaneco Katac‑Amac.\n\nEn sus alrededores destacan la Montaña Piedra Blanca al norte, parte del Parque nacional de la Sierra de Agalta, con más de ochenta especies de orquídeas, coníferas, plantas latifoliadas y fauna que incluye felinos y quetzales; al oeste se eleva la montaña del Bálsamo y, cerca, el Cerro de la Cruz. La ciudad alberga las Cuevas de Talgua, tres iglesias católicas y diversas congregaciones religiosas, así como varios colegios, centros de asistencia médica y es lugar de nacimiento del expresidente José Manuel Zelaya Rosales."
  },
  {
    "slug": "socopo",
    "name": "Socopó",
  ...
  },
  {
    ...
    "intro": "Santa Bárbara de Samaná, municipio dominicano fundado en 1756, cuenta con 63 359 habitantes según el censo 2022 y su economía se centra en el turismo.",
    "aboutTitle": "Origen del nombre y fundación de Santa Bárbara de Samaná",
    "about": "Santa Bárbara de Samaná, comúnmente llamado Samaná, es un municipio de la República Dominicana situado en la provincia del mismo nombre. Su nombre proviene del taíno, escrito como Xamaná por los primeros cronistas de Indias, y según Alberti sería de origen fenicio con el significado «Lugar donde arribo el jefe cartaginés Zammna». En 1756 el rey Fernando VI ordenó al gobernador Francisco Rubio y Peñaranda la fundación de la ciudad, añadiendo el nombre de Santa Bárbara en honor a la entonces reina de España, Bárbara de Braganza. Los primeros pobladores fueron familias españolas procedentes de las Islas Canarias.\n\nEn 1824, mientras la República Dominicana estaba bajo el gobierno de Jean‑Pierre Boyer, se asentó una comunidad de negros norteamericanos en Samaná. Tras la independencia, la Ley sobre la Administración Provincial de 1845 convirtió a Samaná en común de la provincia de El Seibo; la Constitución del 14 de noviembre de 1865 lo elevó a Distrito Marítimo y, con la Constitución promulgada el 9 de septiembre de 1907 bajo la presidencia de Ramón Cáceres, se transformó en provincia con su cabecera en Santa Bárbara de Samaná. Según el Censo de Población y Vivienda de 2022, el municipio tenía una población total de 63 359, de los cuales 31 968 eran hombres y 31 391 mujeres, y la población urbana representaba el 39,8 % del total. Las principales actividades económicas del municipio son el turismo."
  },
  {
    "slug": "la-union-norte",
    "name": "La Unión Norte",
  ...
  },
  {
    ...
    "intro": "El Estor, en el departamento de Izabal, Guatemala: el segundo municipio más grande, solo por detrás de Livingston.",
    "aboutTitle": "El segundo municipio más grande de Izabal, tras Livingston",
    "about": "El Estor es un municipio del departamento de Izabal, en el nor-oriente de Guatemala, a 121 kilómetros de Puerto Barrios y a 319 kilómetros de la capital del país. Es el segundo municipio más grande de todo Izabal, superado únicamente por Livingston, lo que le da un peso territorial considerable dentro del departamento. Esa combinación de tamaño y distancia respecto a los dos grandes centros urbanos de referencia —Puerto Barrios en la costa y la capital en el interior— es lo que mejor sitúa a El Estor dentro de la geografía de Izabal: un municipio grande, pero alejado de los núcleos urbanos más consolidados del departamento."
  },
  {
    ...
    "intro": "Santa Bárbara del Zulia: parroquia del municipio Colón, conurbada con San Carlos del Zulia, en el estado Zulia.",
    "aboutTitle": "Conurbada con San Carlos del Zulia, capital del municipio Colón",
    "about": "Santa Bárbara de Zulia es una parroquia del municipio Colón, en el estado Zulia, Venezuela. Forma una conurbación junto con San Carlos del Zulia, la capital de ese mismo municipio, lo que significa que ambas poblaciones han crecido hasta quedar unidas urbanísticamente, sin una frontera clara entre una y otra. Esa condición de parroquia conurbada con la capital municipal, más que una localidad independiente y separada, es el dato clave para entender la posición de Santa Bárbara del Zulia dentro del municipio Colón, en el estado Zulia venezolano, pegada por completo al núcleo urbano de la capital de ese mismo municipio."
  },
  {
    "slug": "sahuayo",
    "name": "Sahuayo",
    ...
    "intro": "Sahuayo, en Michoacán: la ciudad que Pedro Infante llamó «la médula de la hembra mexicana», con nombre náhuatl de vasija-tortuga.",
    "aboutTitle": "La médula de la hembra mexicana, según Pedro Infante",
    "about": "Sahuayo de Morelos es una ciudad del estado de Michoacán de Ocampo, en el centro-occidente de México, y cabecera del municipio de Sahuayo. El actor y cantante Pedro Infante la llamó «la médula de la hembra mexicana», una frase que se sigue asociando a la ciudad hasta hoy. Su nombre viene del náhuatl tzacuatlayotl, formado por la unión de tzacuatl, que significa «vasija», y ayotl, que significa «tortuga»: en conjunto, una vasija con forma de tortuga. Ese origen del nombre, poco habitual entre las ciudades michoacanas, es uno de los datos que más se repite al presentar a Sahuayo fuera de la región."
  },
  {
    ...
    "intro": "San José Iturbide, al noreste de Guanajuato: su nombre une al santo patrono y al primer emperador de México, y forma parte del municipio homónimo.",
    "aboutTitle": "Un nombre entre un santo patrono y un emperador",
    "about": "San José Iturbide es una ciudad situada en el noreste del estado de Guanajuato y constituye la cabecera del municipio homónimo. Su denominación combina dos referencias históricas: por un lado el santo patrono José de Nazaret, y por otro el primer emperador de México, Agustín de Iturbide. Esta unión de raíces religiosas y políticas otorga a la localidad una identidad singular dentro de la zona. El topónimo refleja la influencia de la época de la independencia y la tradición católica que ha marcado la historia local. La ciudad se encuentra en una zona de relieve suavemente ondulado, característica del norte de Guanajuato, y forma parte del entramado de poblaciones que integran la región noreste del estado. La presencia de ambos nombres en el mismo lugar resalta la convivencia de la fe y la memoria histórica en el desarrollo urbano y cultural de San José Iturbide."
  },
  {
    "slug": "yuriria",
    "name": "Yuriria",
    ...
    "intro": "Yuriria, en el sur del estado mexicano de Guanajuato: Pueblo Mágico desde 2012, cabecera de su propio municipio.",
    "aboutTitle": "Pueblo Mágico desde 2012, en el sur de Guanajuato",
    "about": "Yuriria es una localidad mexicana, cabecera del municipio que lleva su mismo nombre, situada en el sur del estado de Guanajuato. En 2012 fue incluida en el programa turístico Pueblos Mágicos, el mismo reconocimiento que reciben localidades mexicanas por su valor histórico y cultural. Esa distinción, sumada a su condición de cabecera municipal, es de los pocos datos verificables con los que se puede describir hoy a Yuriria dentro del sur de Guanajuato, un estado con varias localidades reconocidas dentro de ese mismo programa turístico nacional, entre las que se cuenta también esta misma cabecera municipal desde hace más de una década."
  },
  {
    "slug": "huanchaco",
    "name": "Huanchaco",
    ...
    "intro": "Huanchaco, balneario histórico del departamento de La Libertad: capital de distrito en la provincia de Trujillo.",
    "aboutTitle": "Capital de distrito y balneario histórico a la vez",
    "about": "Huanchaco es una ciudad y balneario histórico peruano, capital del distrito que lleva su mismo nombre, dentro de la provincia de Trujillo, en el departamento de La Libertad. Según la estimación y proyección del INEI para 2020, su población alcanzaba los 87.192 habitantes. Esa doble condición —capital de distrito y balneario histórico a la vez— es la que mejor resume el lugar que ocupa Huanchaco dentro de la provincia de Trujillo, distinto de otros distritos de la misma provincia que no tienen ese carácter costero e histórico combinado, y es también lo que explica que se le identifique tanto por su papel administrativo como por su tradición de balneario."
  },
  {
    "slug": "guines",
    "name": "Güines",
    ...
    "parentName": "Cuba",
    "parentSlug": "cuba",
    "provincia": "provincia de Mayabeque",
    "regionSlug": "provincia-de-mayabeque",
    "channels": [
      "cuba",
      "latinoamerica",
      "chatzona"
    ...
    "intro": "Güines, a orillas del río Mayabeque: fundada en 1735, hoy el mayor núcleo urbano de la provincia de Mayabeque.",
    "aboutTitle": "El primer núcleo urbano de la provincia de Mayabeque",
    "about": "La ciudad de San Francisco Javier y San Julián de los Güines, conocida simplemente como Güines, está a 54 kilómetros al sur de La Habana, a orillas del río Mayabeque, en una de las llanuras más fértiles de Cuba. Se fundó en 1735 junto a su iglesia, la de San Julián. Perteneció hasta 2010 a la provincia de La Habana, y desde el 1 de enero de 2011 forma parte de la nueva provincia de Mayabeque, de la que es el primer núcleo urbano en población y el segundo municipio en importancia, después de la capital provincial, San José de las Lajas."
  },
  {
    "slug": "banes",
    "name": "Banes",
    ...
    "intro": "Banes, en el extremo norte de la provincia cubana de Holguín: litoral, playas, bahías y mucha historia acumulada.",
    "aboutTitle": "El extremo norte de la provincia de Holguín",
    "about": "Banes es una ciudad y uno de los 14 municipios que forman la provincia de Holguín, en Cuba, situado en su extremo septentrional. El municipio se distingue sobre todo por su litoral, con playas y bahías que marcan buena parte de su paisaje, además de por su historia y su patrimonio cultural acumulado a lo largo del tiempo. Esa combinación de costa y patrimonio es lo que más se destaca de Banes dentro del conjunto de municipios que forman la provincia de Holguín, junto a otros municipios costeros del mismo extremo norte de la provincia, con los que comparte ese mismo perfil de litoral y bahías recortadas en la costa."
  },
  {
    "slug": "ilo",
    "name": "Ilo",
    ...
    "intro": "Ilo, en el departamento de Moquegua, Perú: capital de su provincia, a orillas del Pacífico, con 69.376 habitantes.",
    "aboutTitle": "A orillas del Pacífico, entre el río Osmore y punta Coles",
    "about": "Ilo es una ciudad peruana, capital del distrito y de la provincia que llevan su mismo nombre, en el departamento de Moquegua. Está situada en el suroeste del país, a orillas del océano Pacífico, al sur de la desembocadura del río Osmore y al norte de punta Coles. Se encuentra a 92 kilómetros de la ciudad de Moquegua, y según el censo de 2025 cuenta con una población estimada de 69.376 habitantes. Esa combinación de capital provincial y ciudad costera, entre un río y una punta que le dan nombre a su entorno geográfico inmediato, define bien la posición de Ilo dentro de Moquegua."
  },
  {
    "slug": "palpala",
    "name": "Palpalá",
    ...
    "parentName": "Argentina",
    "parentSlug": "argentina",
    "provincia": "Provincia de Jujuy",
    "regionSlug": "provincia-de-jujuy",
    "channels": [
      "argentina",
      "latinoamerica",
      "chatzona"
    ...
    "intro": "Palpalá, en la provincia argentina de Jujuy: cabecera de su propio departamento, a 13 km de San Salvador de Jujuy.",
    "aboutTitle": "Cabecera departamental a 13 km de San Salvador de Jujuy",
    "about": "Palpalá es una ciudad argentina, cabecera del departamento que lleva su mismo nombre, en la provincia de Jujuy. Está ubicada a 13 kilómetros al sudeste de San Salvador de Jujuy, la ciudad capital de la provincia, y a una altitud de 1.125 metros sobre el nivel del mar. Esa cercanía con la capital provincial, sumada a su condición de cabecera departamental propia, es lo que mejor sitúa a Palpalá dentro de la geografía de Jujuy: ni forma parte de la capital, ni está lejos de ella, sino justo en su periferia inmediata hacia el sudeste, a una altitud considerable dentro del relieve de la provincia."
  },
  {
    "slug": "gomez-palacio",
    "name": "Gómez Palacio",
