...
export const CITIES_GENERADAS: Place[] = [
  ...
  },
  {
    ...
    "intro": "Chat de La Pintana, la comuna del sur del Gran Santiago: la del campus Antumapu de la Universidad de Chile y los antiguos huertos obreros.",
    "aboutTitle": "La Pintana: comuna del sector sur dentro del Gran Santiago",
    "about": "La Pintana es una comuna ubicada en el sector sur de la ciudad de Santiago, capital de Chile, y forma parte del Gran Santiago dentro de la Región Metropolitana. En la sala de chat de La Pintana los usuarios comentan temas cotidianos como transporte, seguridad, servicios municipales y actividades culturales de la comuna. Participan residentes, estudiantes y trabajadores del sector, intercambiando información y opiniones sobre la vida local. El espacio sirve como punto de encuentro virtual donde se comparten avisos, se resuelven dudas y se fomenta la colaboración entre vecinos. El nombre viene del fundo La Pintana, que fue de la familia del presidente Aníbal Pinto y que en 1942 compró la Caja de la Habitación Popular para instalar allí los Huertos Obreros y Familiares: de aquel reparto salieron la Villa La Pintana, Villa Las Rosas y Mapuhue, que siguen llamándose igual. El casco urbano se formó en los años cuarenta en lo que hoy es San Rafael, con la Plaza de Armas, el Estadio Municipal y la Casa de la Cultura. Y dentro de la comuna está el campus Antumapu de la Universidad de Chile, el de las facultades silvoagropecuarias, así que por la sala pasan estudiantes que se bajan en Santa Rosa cada mañana además de vecinos de toda la vida."
  },
  {
    "slug": "ciudad-valles",
    "name": "Valles",
